...
public class BlockquoteTest {
  ...
  public void setUp() {
    ...
    this.b1 = new Blockquote(list1, 1);
  ...
  public void testToPrettyString() {
    ...
    String expectedOutput1 = "<blockquote>" + "<p> What are the resources allocated?</p>\n"
        + "<blockquote>" + "<p> Are you asking in terms of headcount or machines?</p>\n"
        + "<blockquote>" + "<p> Headcount</p>\n" + "<blockquote>" + "<blockquote>"
        + "<p> jump from 3rd to 5th</p>\n" + "</blockquote>\n" + "</blockquote>\n"
        + "</blockquote>\n" + "</blockquote>\n" + "</blockquote>\n";
    Blockquote bq = new Blockquote(test);
    Assert.assertEquals(expectedOutput1, bq.toPrettyString());
  }
