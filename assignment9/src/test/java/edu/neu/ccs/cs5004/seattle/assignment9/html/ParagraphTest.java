...
public class ParagraphTest {
  ...
  public void testToPrettyString() {
    ...
    String output3 =
        "<p>This paragraph <strong>should have two</strong> sections in <strong>bold</strong></p>\n";
    ...
    String output4 =
        "<p>The rest of this sentence after this point <strong>should be in bold</strong></p>\n";
