...
public abstract class AbstractList extends AbstractElement {
    ...
    /**
     * Helper method for creating regular, nested, and/or mixed lists. Keeps
     * track of the last item that was added to the itemList. input is in
     * process of being created, and leadingSpace accumulates spaces based on
     * nesting level of the input list
     *
