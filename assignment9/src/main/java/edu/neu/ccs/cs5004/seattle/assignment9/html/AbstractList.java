...
public abstract class AbstractList extends AbstractElement {
     ...
     * with ordered lists beginning with special character "1." and unordered
     * lists with special character "* ". Every two leading spaces represent an
     * extra nesting level. The first level has zero leading spaces.
    ...
    /**
     * Parses the given list of strings and converts to html format based on the
     * html list template
     *
     * @param input a list of strings formatted in html list-template style
    ...
    /**
     *
     * @param resultingList an accumulator for the input list elements that have
     * been converted into html structured format
     * @param lastItem the most recently added item of resultingList
     * @param input a list of strings formatted in html list-template style
     * @param leadingSpace the leading space of the list item, including special
     * characters "1." or "* "
     */
