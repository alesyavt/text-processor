...
public class UnorderedList extends AbstractList {
    ...
    /**
     * Create an abstract list beginning with an unordered list, given a list of
     * strings formatted according to template specifications for abstract list.
     *
     * @param input a list of strings formatted with special characters, "* "
     * for unordered list and "1. " for ordered list.
